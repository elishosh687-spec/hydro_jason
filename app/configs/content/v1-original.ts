...
export const content = {
  ...
  heroVideoCarousel: {
    slides: [
      ...
      },
      {
        id: 3,
        type: 'image' as const,
        alt: 'המוצר Feed-Ease - מבט מקרוב',
      },
      {
        id: 4,
        type: 'image' as const,
        alt: 'תינוק רגוע אחרי האכלה עם Feed-Ease',
      },
      {
        id: 5,
        type: 'image' as const,
        alt: 'המוצר בשימוש יומיומי',
      },
    ],
  ...
  problemSolution: {
    ...
    // כותרת ראשית - הבעיה
    mainHeadline: 'למה את מחכה שהגב יישבר?',
    // כותרת משנה
    subheadline:
      'כל האכלה נוספת עם אלתורים היא עומס מיותר על הגוף שלך. אם את מסמנת "כן", את חייבת את זה לעצמך',
    // רשימת נקודות כאב
    painPoints: [
      {
        id: 1,
        ...
        // מילה מודגשת
        highlight: '"להנדס"',
        textAfter: ' כריות שנופלות ברגע שאת זזה מילימטר',
      },
      {
        id: 2,
        text: 'היד שלך צועקת ',
        highlight: '"הצילו"',
        textAfter: ' והכתף שורפת, אבל את מפחדת לשחרר אחיזה',
      },
      {
        id: 3,
        text: 'בטבמקום לישון אחרי האוכל, אנחנו מתמודדים עם שעות של צרחות ',
        highlight: 'גזים',
      },
      {
        id: 4,
        text: 'הקפה שלך שוב התקרר, ואת תקועה באותה תנוחה כבר ',
        highlight: '20 דקות',
      },
      {
        id: 5,
        text: 'את יודעת שיש דרך קלה יותר, ואת רוצה את הידיים שלך בחזרה – ',
        highlight: 'עכשיו',
      },
    ],
    // קופסת הפתרון
    solutionBox: {
      ...
      // תוכן הפתרון
      bodyText:
        'במקום שהיד שלך תרעד ממאמץ, המערכת שלנו עושה את העבודה בשבילך. את מקבלת ידיים פנויות לחלוטין (לקפה, לנייד או למנוחה), והבייבי נהנה מהאכלה יציבה ובטוחה שמונעת גזים',
      // טקסט נטוי
      italicText: 'ידיים פנויות לחלוטין',
    },
    // placeholder לוידאו
    videoPlaceholder: {
      title: 'וידאו סטורי',
  ...
  socialProof: {
    ...
    reviews: [
      ...
      },
      {
        ...
        text: 'הרגשתי איך כל המתח יוצא לי מהכתפיים ברגע שהנחתי את הבקבוק בכרית. פתאום יש לי זמן לנשום בזמן שהוא אוכל בבטחה.',
        timeAgo: 'לפני 4 שעות',
        likes: 214,
        comments: 17,
      },
      {
        ...
        text: 'סוף סוף הידיים שלי משוחררות והגב שלי נח. התחושה שחזרתי לעצמי בזמן שהבייבי שבע ועצמאי היא פשוט הצלת חיים',
        timeAgo: 'לפני 3 ימים',
        likes: 98,
        comments: 6,
      },
      {
        ...
        name: 'שני דוידי',
        initials: 'שד',
        image: 'https://images.unsplash.com/photo-1488426862026-3ee34a7d66df?w=100&h=100&fit=crop&q=80',
        text: 'הרגשתי שקיבלתי את היד השלישית שתמיד חלמתי עליה. הגב שלי סוף סוף נח והידיים פנויות, וזה פשוט שקט תעשייתי שנותן לי אוויר לנשימה.',
        timeAgo: 'לפני שבוע',
        likes: 167,
        comments: 11,
      },
